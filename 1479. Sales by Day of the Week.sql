...
SELECT 
A. ITEM_CATEGORY,
COALESCE(DATE_FORMAT(B.ORDER_DATE,'%W'),0) AS WEEK_NAME,
...
SELECT 
    ITEM_CATEGORY AS CATEGORY,
    SUM(CASE WHEN WEEK_NAME='Monday' THEN QUANTITY ELSE 0 END) AS MONDAY,
    SUM(CASE WHEN WEEK_NAME='Tuesday' THEN QUANTITY ELSE 0 END) AS TUESDAY, 
    SUM(CASE WHEN WEEK_NAME='Wednesday' THEN QUANTITY ELSE 0 END) AS WEDNESDAY, 
    SUM(CASE WHEN WEEK_NAME='Thursday' THEN QUANTITY ELSE 0 END) AS THURSDAY, 
    SUM(CASE WHEN WEEK_NAME='Friday' THEN QUANTITY ELSE 0 END) AS FRIDAY, 
    SUM(CASE WHEN WEEK_NAME='Saturday' THEN QUANTITY ELSE 0 END) AS  SATURDAY, 
    SUM(CASE WHEN WEEK_NAME='Sunday' THEN QUANTITY ELSE 0 END) AS SUNDAY 
FROM CTE 
GROUP BY 1
ORDER BY 1